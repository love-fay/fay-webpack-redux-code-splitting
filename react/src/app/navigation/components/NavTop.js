        ...
        return (
            ...
            >
                ...
                {this.state.user ? (<Menu.Item
                        ...
                        <div className={style.userInfo + ' waves-effect'}>{this.state.user.nickname}</div>
                    </Menu.Item>) : (<Menu.Item
                        key="/prevent2" style={{float: 'right', marginRight: '50px'}}>
                        <div className={style.login + ' waves-effect'} onClick={(e) => {this.changePath(e, '/login');}}>登录</div></Menu.Item>)}
